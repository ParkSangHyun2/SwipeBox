...
<body>
	...
	<div id="index-banner" class="parallax-container">
		<div class="section no-pad-bot">
			<div class="container">
				...
				<div class="row center">
					<a href="/project/link" id="download-button"
		...
		<div class="parallax">
			<img
				src="${pageContext.request.contextPath}/resources/background/background1.jpg"
	...
	<div class="parallax-container valign-wrapper">
		...
		<div class="parallax">
			<img
				src="${pageContext.request.contextPath}/resources/background/background2.jpg"
